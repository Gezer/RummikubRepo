...
public class GameBuilder {
    ...
    private static HashMap<String, Boolean> createPlayerInfo(generated.Players players) {
        HashMap<String, Boolean> playetInfo = new HashMap<>();

        for (generated.Players.Player player : players.getPlayer()) {
            playetInfo.put(player.getName(), player.getType() == generated.PlayerType.COMPUTER);
        }
